...
<head>
    ...
    <link rel="stylesheet" href="xgl/adminlogin/bootstrap.min.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,800">
    <link rel="stylesheet" href="xgl/adminlogin/orionicons.css">
    <link rel="stylesheet" href="xgl/adminlogin/style.default.css" id="theme-stylesheet">
    <link rel="stylesheet" href="xgl/adminlogin/custom.css">
    <link rel="shortcut icon" href="xgl/adminlogin/favicon.png?3">
    ...
    <div class="container">
        <div class="row align-items-center py-5">
            <div class="col-5 col-lg-7 mx-auto mb-5 mb-lg-0">
                <div class="pr-lg-5">
                    <img src="xgl/adminlogin/illustration.svg" alt="" class="img-fluid">
                </div>
            </div>
...
<!-- JavaScript files-->
<script src="xgl/adminlogin/jquery.min.js"></script>
<script src="xgl/adminlogin/popper.min.js"> </script>
<script src="xgl/adminlogin/bootstrap.min.js"></script>
<script src="xgl/adminlogin/jquery.cookie.js"> </script>
<script src="xgl/adminlogin/Chart.min.js"></script>
<script src="xgl/adminlogin/js.cookie.min.js"></script>
<script src="xgl/adminlogin/front.js"></script>
